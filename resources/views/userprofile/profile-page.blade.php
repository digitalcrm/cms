            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="account" role="tabpanel">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('auth_profile.update',auth()->user()->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input
                                            type="text"
                                            class="form-control @error('name') required @enderror" id="inputUsername"
                                            name="name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                            type="email"
                                            class="form-control @error('email') required @enderror" id="inputEmail4"
                                            name="email"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input
                                                type="text"
                                                class="form-control required @error('firstname') required @enderror" id="inputFirstName"
                                                name="firstname"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input
                                                type="text"
                                                class="form-control required @error('lastname') required @enderror" id="inputLastName"
                                                name="lastname"
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-center">
                                            <img alt="{{ $profileinfo->name }}" src="{{ $profileinfo->profile_photo_url }}" class="rounded-circle img-responsive mt-2" width="128" height="128">
                                            <div class="mt-2">
                                                {{-- <span class="btn btn-primary">
                                                    ...
                                                    </svg><!-- <i class="fas fa-upload"></i> --> Upload
                                                </span> --}}
                                                <input
                                                type="file"
