                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="custom-select" name="page_id" id="selectDropDown" required>
                                <option selected disabled value="0">Choose...</option>
                                @foreach($pages as $id => $title)
                                    <option value="{{ $id }}">{{ $title }}</option>
                                @endforeach
                            </select>
                            <input type="text" class="form-control custom-hide" id="urlPage" name="urlText" placeholder="{{ env('APP_URL') }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group form-check">
                            <input type="checkbox" name="pageCheckBox" class="form-check-input" id="pageCheckBox">
                            <label class="form-check-label" for="pageCheckBox">URL</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-check">
                          <input class="form-check-input" name="isChecked" type="checkbox" value="" id="invalidCheck">
