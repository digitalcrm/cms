    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
                ...
                <button type="button" class="btn btn-primary primary-custom btn-lg float-left px-4 mr-3">Online
                    Demo</button>
                <button type="button" class="btn btn-outline-secondary secondary-custom btn-lg px-4 float-left">Buy
                    Now</button>
            </div>
        </div>
...
<div class="container">
    <div class="row featured-post-heading">
        <div class="col-md-12 text-center">
            ...
            <p class="mb-5">Lorem ipsum amore amatum amatus dolor sit amet, consectetur adipiscing elit. Aenean eu
                ornare ante. Proin aliquam odio id lorem finibus, a ullamcorper arcu posuere. Pellentesque nec neque ac
                lorem malesuada.</p>
        </div>
    </div>
    <div class="row text-center">
        <div class="col-md-4">
            <div class="featured-post">
                ...
                <p class="blog-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean eu ornare ante.
                    Proin aliquam odio id lorem finibus, a ullamcorper arcu posuere.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="featured-post">
...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p>From banking and insurance to wealth management and on securities distribution, we dedicated financial
                services them the teams serve all major sectors. of the industry.</p>
            <p>Our work draws on more than 40 years of experience. They delivered by 5,700 professionals in the world’s
                most. important financial centers.</p>
            <p>From banking and insurance to wealth management and on securities distribution, we dedicated financial
                services them the teams serve all major sectors. of the industry.</p>
            <button type="button" class="btn btn-primary primary-custom btn-lg float-left px-4 mt-4 mr-3">Get
                Started</button>
            <button type="button" class="btn btn-outline-secondary secondary-custom btn-lg px-4 float-left mt-4">Free
                Trial</button>
        </div>
    </div>
</div>
<div class="container-fluid bg-dark3 text-center mt-5 client-custom">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2">
                <img src="{{ asset('img/client1.png') }}" class="img-fluid thumbnail card"
                    alt="...">
            </div>
            <div class="col-md-2">
                <img src="{{ asset('img/client2.png') }}" class="img-fluid thumbnail card"
                    alt="...">
            </div>
            <div class="col-md-2">
                <img src="{{ asset('img/client3.png') }}" class="img-fluid thumbnail card"
                    alt="...">
            </div>
            <div class="col-md-2">
                <img src="{{ asset('img/client4.png') }}" class="img-fluid thumbnail card"
                    alt="...">
            </div>
            <div class="col-md-2">
                <img src="{{ asset('img/client5.png') }}" class="img-fluid thumbnail card"
                    alt="...">
            </div>
            <div class="col-md-2">
                <img src="{{ asset('img/client3.png') }}" class="img-fluid thumbnail card"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p class="mb-5">Aliquam sodales justo sit amet urna auctor scelerisquinterdum leo anet tempus enim esent
                    egetis hendrerit vel nibh vitae ornar sem velit aliquam facilisivitae finibus risus feslin is
                    hendrerit vel nibh vitae ornar uspendisse consequat quis sem.</p>
            </div>
            <div class="col-md-3">
...
<div class="container text-center mt-5">
    <div class="row testimonial">
        <div class="col-md-12 text-center">
            ...
            <p class="mb-5">Aliquam sodales justo sit amet urna auctor scelerisquinterdum leo anet tempus enim esent
                egetis<br> hendrerit vel nibh vitae ornar sem velit aliquam facilisivitae.</p>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <figure class="snip1192 hover">
                <blockquote>Thank you. before I begin, I'd like everyone to notice that my report is in a professional,
                    clear plastic binder...When a report looks this good, you know it'll get an A. That's a tip kids.
                    Write it down.</blockquote>
                <div class="author">
        ...
        <div class="col-md-4">
            <figure class="snip1192">
                <blockquote>My behaviour is addictive functioning in a disease process of toxic co-dependency. I need
                    holistic healing and wellness before I'll accept any responsibility for my actions.</blockquote>
                <div class="author">
...
<div class="container mt-5">
    <div class="row testimonial">
        <div class="col-md-6">
            ...
            <p>Feel free to contact us. A business has to be involving, it has to be fun, and it has to exercise your
                creative instincts. Start where you are. Use what you have. Do what you can.</p>
